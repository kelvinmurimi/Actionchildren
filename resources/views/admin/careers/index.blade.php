     ...
     <div>
        ...
        <div class="mt-5 mb-5 grid sm:grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="col-span-2">
                <x-form.input type="search" name="name" wire:model="name" label="none" :placeholder="__('Search Jobs')" />
            </div>
        ...
        <div class="flex space-x-2 justify-end p-3">
            <a href="{{ route('admin.careers.create') }}"class="btn btn-primary p-3">{{ __('Add Job') }}</a>
                        ...
                        <tr>
                            <td class="flex">
                                <div>
                                    ...
                                    <a href="{{ asset($career->document) }}" alt="{{ $career->title }}" class="mr-5 ml-4 p-5">Download</a>

                                </div>
                                <div class="pl-1 pt-1">{{ Str::limit($career->title, 100) }}</div>
                            </td>
                            <td>
                                <div class="flex space-x-2">
                                    <a
                                        href="{{ route('admin.careers.edit', $career->id) }}"class="btn btn-primary">{{ __('Edit') }}</a>
