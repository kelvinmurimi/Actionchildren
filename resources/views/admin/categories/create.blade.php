    ...
    <div>
        <div class="card">
            ...
            <div class="flex justify-between">
                <h4 class="mb-5 text-bold text-indigo-800">{{ __('Publish Page') }}</h4>
                ...
                <div class="flex space-x-2 justify-end p-3">
                    <a href="{{ route('categories.index') }}"class="btn btn-primary p-3">{{ __('Back To Pages') }}</a>
            ...
            <form method="post" action="{{ route('categories.store') }}" >
                ...
                <div class="mb-5">
                    <div class="rounded-md shadow-sm">
                        {{-- Article Title --}}
                        <label for="Article Title" class="block text-sm font-medium leading-5 text-gray-700 dark:text-gray-200"><strong>Page Name</strong></label>
