            ...
            <tr>
                <div class="mr-8">
                    ...
                    <td>
                        ...
                        <div class="pl-8 pt-1 "><strong>{{$contact->name }}</strong></div>
                    </td>
                    <td>

                        <div class="pl-8 pt-1 "><strong>{{$contact->email }}</strong></div>
                    </td>
                    <td>

                        <div class="pl-8 pt-1 "><strong>{{$contact->phone }}</strong></div>
                    </td>
                </div>
               <td>
                    <div class="flex space-x-1">
                      <a href="{{ route('admin.contacts.show',$contact->id) }}"class="btn btn-primary" >{{ __('View') }}</a>
