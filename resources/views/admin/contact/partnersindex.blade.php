...
<div>
    ...
    <div class="flex space-x-2 justify-end p-3">
        <a href="{{ route('admin.partners.data') }}"class="btn btn-primary p-3" >{{ __('Welcome ') }}{{auth()->user()->name}}</a>
            ...
            <tr>
                <div class="mr-8">
                    ...
                    <td>
                        ...
                        <div class="pl-8 pt-1 "><strong>{{$partner->name }}</strong></div>
                    </td>
                    <td>

                        <div class="pl-8 pt-1 "><strong>{{$partner->email }}</strong></div>
                    </td>
                    <td>

                        <div class="pl-8 pt-1 "><strong>{{$partner->phone }}</strong></div>
                    </td>
                </div>
               <td>
                    <div class="flex space-x-1">
                      <a href="{{ route('admin.partners.showdata',$partner->id) }}"class="btn btn-primary" >{{ __('View') }}</a>
