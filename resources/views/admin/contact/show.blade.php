...
<div>
    ...
    <div class="overflow-x-scroll shadow-md">
        ...
        <tr>
            ...
            <th><a href="#" wire:click.prevent="sortBy('first_name')">{{ __('content') }}</a></th>
        ...
        <tbody>
            ...
            <tr>
                <div class="mr-8">
                   ...
                   <td>
                        <div class="pl-8 pt-1 "><strong>{{$contact->content }}</strong></div>
                    </td>
                </div>
               <td>
                    <div class="flex space-x-1">
                      <a href="{{ route('admin.contacts.show',$contact->id) }}"class="btn btn-primary" >{{ __('Back') }}</a>
