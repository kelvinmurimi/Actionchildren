    ...
    <div>
        ...
        <div class="mt-5 mb-5 grid sm:grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="col-span-2">
                <x-form.input type="search" name="name" wire:model="name" label="none" :placeholder="__('Search partners')" />
            </div>
        ...
        <div class="flex space-x-2 justify-end p-3">
            <a href="{{ route('admin.partners.create') }}"class="btn btn-primary p-3">{{ __('Add partner') }}</a>
        ...
        <div class="overflow-x-scroll shadow-md">
            <table>
                <thead>
                    <tr>
                        <th><a href="#" wire:click.prevent="sortBy('first_name')">{{ __('Partner Name') }}</a></th>
                        ...
                        <tr>
                            <td class="flex">
                                <div>
                                    ...
                                    <img src="{{ asset($partner->image) }}" alt="{{ $partner->name }}" width="80"
                                        class="h-12 w-12 rounded-full">

                                </div>
                                <div class="pl-1 pt-1">{{ Str::limit($partner->description, 100) }}</div>
                            </td>
                            <td>
                                <div class="flex space-x-2">
                                    <a
                                        href="{{ route('admin.partners.edit', $partner->id) }}"class="btn btn-primary">{{ __('Edit') }}</a>
