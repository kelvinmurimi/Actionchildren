...
<div>
    ...
    <div class="mt-5 mb-5 grid sm:grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="col-span-2">
            <x-form.input type="search" name="name" wire:model="name" label="none" :placeholder="__('Search Emails')" />
        </div>
    ...
    <div class="flex space-x-2 justify-end p-3">
        <a href="{{ route('admin.contacts.index') }}"class="btn btn-primary p-3" >{{ __('Welcome ') }}{{auth()->user()->name}}</a>
    ...
    <div class="overflow-x-scroll shadow-md">
        ...
        <tr>
            ...
            <th><a href="#" wire:click.prevent="sortBy('first_name')">{{ __('Email') }}</a></th>
            <th><a href="#" wire:click.prevent="sortBy('first_name')">{{ __('Phone') }}</a></th>
            ...
            <tr>
                <div class="mr-8">
                    ...
                    <td>
                        ...
                        <div class="pl-8 pt-1 "><strong>{{$volunteer->name }}</strong></div>
                    </td>
                    <td>

                        <div class="pl-8 pt-1 "><strong>{{$volunteer->email }}</strong></div>
                    </td>
                    <td>

                        <div class="pl-8 pt-1 "><strong>{{$volunteer->phone }}</strong></div>
                    </td>
                </div>
               <td>
                    <div class="flex space-x-1">
                      <a href="{{ route('admin.volunteercontacts.show',$volunteer->id) }}"class="btn btn-primary" >{{ __('View') }}</a>
