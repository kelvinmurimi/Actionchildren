    ...
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
          <h3 class="fs-6 text-secondary mb-2 text-uppercase text-center text-primary" >Our Success Stories</h3>
          <h2 class="mb-4 display-5 text-center">Our Success Stories.</h2>
    ...
    <div class="container">
      <div class="row gy-4 gy-lg-0 align-items-lg-center">
        <div class="col-12 col-lg-6">
          <img class="img-fluid rounded" loading="lazy" src="{{ asset('frontend/homeimg/second.jpg') }}" alt="Our Success">
        </div>
        <div class="col-12 col-lg-6">
                ...
                <div class="col-12 col-sm-6">
                  <div class="card border-0 border-bottom border-primary shadow-sm mb-4">
                    <div class="card-body text-center p-4 p-xxl-5">
                      <h5 class="display-2 fw-bold mb-2">1500+</h5>
                      <p class="fs-5 mb-0 text-secondary">Children Supported</p>
                    </div>
                  </div>
                  <div class="card border-0 border-bottom border-primary shadow-sm">
                    <div class="card-body text-center p-4 p-xxl-5">
                      <h5 class="display-2 fw-bold mb-2">15+</h5>
                      <p class="fs-5 mb-0 text-secondary">Partners</p>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6">
                  <div class="card border-0 border-bottom border-primary shadow-sm mt-lg-6 mt-xxl-8 mb-4">
                    <div class="card-body text-center p-4 p-xxl-5">
                      <h5 class="display-2 fw-bold mb-2">300+</h5>
                      <p class="fs-5 mb-0 text-secondary">Volunteers</p>
                    </div>
                  </div>
                  <div class="card border-0 border-bottom border-primary shadow-sm">
                    <div class="card-body text-center p-4 p-xxl-5">
                      <h5 class="display-2 fw-bold mb-2">20+</h5>
  ...
  <div class="container">
    <div class="row gy-3 gy-md-5 gy-lg-0 align-items-center">
      <div class="col-12 col-lg-5">
        <h3 class="fs-6 text-secondary mb-2 mb-xl-3">Our Success Stories</h3>
        <h2 class="display-5 mb-3 mb-xl-4">Our Success Stories</h2>
        <p class="mb-4 mb-xl-5">
            Action for Children in Conflic is Dedicated to the improvement of the lives of vulnerable children ,women and communities by promoting their access to : <b>Quality Education</b>, <b>Health</b>, <b>Safe and Clean Environment</b> ,<b>Economic Empowerment</b>   and the protection of their rights and fundamental freedoms.
        </p>
        <a href="{{ route('focusareas') }}" class="btn bsb-btn-2xl btn-primary rounded-pill">More Details</a>
      </div>
          ...
          <div class="col-12 col-xl-11">
            <div class="row gy-3 gy-md-4">
              <div class="col-12 col-sm-6">
                <div class="card border-0 border-bottom border-primary shadow-sm">
                  <div class="card-body text-center p-4 p-xxl-5">
                    <div class="btn btn-primary bsb-btn-circle bsb-btn-circle-4xl pe-none mb-2">
